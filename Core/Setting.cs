...
namespace MifuminSoft.funyan.Core
{
    public class Cf3Setting : IDisposable
    {
        ...
        {
            public string name;
            public int* pdata; // TODO: ここの修正にはロジックの変更も必要
            public bool check;
        }
        protected tagSetting m_Data;
        ...
        { SS_KEY_EXIT,      &m_Key[(int)F3KEY.F3KEY_EXIT],     false},
        { SS_KEY_PAUSE,     &m_Key[(int)F3KEY.F3KEY_PAUSE],    false},
        { SS_KEY_UP,        &m_Key[(int)F3KEY.F3KEY_UP],       false},
        { SS_KEY_LEFT,      &m_Key[(int)F3KEY.F3KEY_LEFT],     false},
        { SS_KEY_RIGHT,     &m_Key[(int)F3KEY.F3KEY_RIGHT],    false},
        { SS_KEY_DOWN,      &m_Key[(int)F3KEY.F3KEY_DOWN],     false},
        { SS_KEY_JUMP,      &m_Key[(int)F3KEY.F3KEY_JUMP],     false},
        { SS_KEY_ATTACK,    &m_Key[(int)F3KEY.F3KEY_ATTACK],   false},
        { SS_KEY_SMILE,     &m_Key[(int)F3KEY.F3KEY_SMILE],    false},
        { SS_KEY_FPS,       &m_Key[(int)F3KEY.F3KEY_FPS],      false},
        { SS_KEY_BGMNONE,   &m_Key[(int)F3KEY.F3KEY_BGMNONE],  false},
        { SS_KEY_BGMDEF,    &m_Key[(int)F3KEY.F3KEY_BGMDEF],   false},
        { SS_KEY_BGMUSER,   &m_Key[(int)F3KEY.F3KEY_BGMUSER],  false},
        { SS_KEY_CAPTURE,   &m_Key[(int)F3KEY.F3KEY_CAPTURE],  false},
        { SS_KEY_RECORD,    &m_Key[(int)F3KEY.F3KEY_RECORD],   false},
    };
